...
<img src="/static/assets/img/blog/cfd_emag/mag_field_coil.jpg" alt="Contours of current density and magnetic field vectors in ANSYS FLUENT viewed from the top (X direction)" style="float:right;width:25%; margin-left: 20px;">

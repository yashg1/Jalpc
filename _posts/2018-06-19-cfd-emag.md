...
![Electromagnetic stirrer](/static/assets/img/blog/cfdemag/contcast.JPG){:height="50%" width="50%" style = "float:right"}

Try 2

![Electromagnetic stirrer](/static/assets/img/blog/cfdemag/contcast.JPG){:class="img-responsive"}

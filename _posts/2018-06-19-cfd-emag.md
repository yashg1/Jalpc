...
```mermaid
graph LR;
  Electrical current in coils --> Magnetic field generated;
  Generated magnetic field-->Induced current (Eddy Currents) in liquid metal;
  Eddy currents & Generated magnetic field--> Lorentz Force;
  Lorentz Force-->Liquid metal stirring;
```

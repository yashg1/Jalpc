...
![Current density contours and magnetic field vector in ANSYS FLUENT](/static/assets/img/blog/cfdemag/magcoil.JPG  "Solving Maxwell's electromagnetic equations using UDF in FLUENT")*Current density contours and magnetic field vector in ANSYS FLUENT*
{:class = "align-right"}

...
![Electromagnetic stirrer](/static/assets/img/blog/cfdemag/em_working.jpg){:height="50%" width="50%"}



{% include image-inline.html url="/static/assets/img/blog/cfdemag/contcast.JPG" width="30%" title = "my title" alt=page.post-title caption="whatever you want here(or nothing)" class="optional-further-styling-class" %}
